...
# Language binaries
export PATH=$PATH:/usr/local/go/bin:/usr/local/cuda/bin:/opt/gradle/gradle-5.5/bin:~/.kotlin/bin:/usr/lib/dart/bin:$HOME/.pub-cache/bin:$GOPATH/bin:$FLUTTER_PATH/bin:$HOME/.cargo/bin:/usr/local/MATLAB/R2019b/bin:$HOME/.konan/kotlin-native-linux-1.3.61/bin
