...
sed -i -e 's/background: .*/background: #FFFFFF;/g' $HOME/.config/rofi/colorscheme.rasi
sed -i -e 's/accent: .*/accent: #2E2E2E;/g' $HOME/.config/rofi/colorscheme.rasi
sed -i -e 's/foreground-list .*/foreground-list #424242;/g' $HOME/.config/rofi/colorscheme.rasi
